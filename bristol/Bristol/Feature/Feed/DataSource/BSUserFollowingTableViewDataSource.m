//
//  BSUserFollowingTableViewDataSource.m
//  Bristol
//
...
@implementation BSUserFollowingTableViewDataSource
{
	BSUserMO *_user;
}

+ (instancetype)dataSourceWithUser:(BSUserMO *)user {
	return [[BSUserFollowingTableViewDataSource alloc] initWithUser:user];
}
