...
- (void)configWithUser:(BSUserMO *)user {
	...
	[self layoutSubviews];
	[self sd_setImageWithURL:[NSURL URLWithString:user.avatar_url] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"common_userdefaultportrait_big"]];
}
...
- (void)configWithTeam:(BSTeamMO *)team {
	...
	[self layoutSubviews];
	[self sd_setImageWithURL:[NSURL URLWithString:team.avatar_url] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"common_teamdefaulticon_small"]];
}
